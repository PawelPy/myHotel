...
public class Hotel {
    ...
    public Hotel() {
        ...
        Room room201 = new Room(Number.ROOM_NO_201, "ba", Standard.STANDARD, Category.TWIN, Floor.FLOOR_1);
        room101.setRoomBeds(Bed.BED_90, 2);

        Room room202 = new Room(Number.ROOM_NO_202, "bb", Standard.STANDARD, Category.TWIN, Floor.FLOOR_1);
        room101.setRoomBeds(Bed.BED_90, 2);

        Room room203 = new Room(Number.ROOM_NO_203, "bc", Standard.BUSINESS, Category.TWIN, Floor.FLOOR_1);
        room101.setRoomBeds(Bed.BED_90, 2);
